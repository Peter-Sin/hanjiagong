      ...
      <div class="row-fluid" >
        <div class="span12" >
          <div class="widget-box" >
            ...
            <!-- <a href="/index.php/Admin/Xinwen/add/">
              <div style="float:right; font:18px 微软雅黑; margin:12px 50px 0px 0px;">增加新闻
              </div>
            </a> -->
            <table class="table " >
              <thead>
                <tr>
                  <th>
                    <span style="font:15px 微软雅黑,黑体">ID</span>
                  </th>
                  <th>
                    <span style="font:15px 微软雅黑,黑体">姓名</span>
                  </th>
                  <th>
                    <span style="font:15px 微软雅黑,黑体">金额</span>
                  </th>
                  <th>
                    <span style="font:15px 微软雅黑,黑体">账号</span>
                  </th>
                  <th>
                    <span style="font:15px 微软雅黑,黑体">类别</span>
                  </th>
                  <th>
                    <span style="font:15px 微软雅黑,黑体">时间</span>
                  </th>
                  <th>
                    <span style="font:15px 微软雅黑,黑体">状态</span>
                  </th>
                  <th>
                    <span style="font:15px 微软雅黑,黑体">操作</span>
                  </th>
                </tr>
              </thead>
              <tbody>
                <?php if(is_array($list)): foreach($list as $key=>$vale): ?><tr class="gradeC">
                    <td style="text-align:center"><?php echo ($vale["id"]); ?></td>
                    <td style="text-align:center"><?php echo ($vale["username"]); ?></td>
                    ...
                    <td style="text-align:center"><?php echo ($vale["time"]); ?></td>
                  ...
                  <!--   <td style="text-align:center">
                    ...
                    <td class="center">
                      <div style="text-align:center;">
                        <?php if($vale["statu"] == 0): ?><a href="/index.php/Admin/Deposit/editstatu/id/<?php echo ($vale["id"]); ?>">修改状态</a>
                        <?php else: ?>
                            <?php if($vale["statu"] == 1): ?><a href="/index.php/Admin/Deposit/editstatu/id/<?php echo ($vale["id"]); ?>">修改状态</a>
                            <?php else: ?>
                            无<?php endif; endif; ?>

                        <!-- <?php if($_SESSION['statu'] == 1): ?><a href="/index.php/Admin/Xinwen/del/id/<?php echo ($vale["id"]); ?>">删除</a>
                        <?php else: endif; ?>  -->
                      </div>
                    </td>
