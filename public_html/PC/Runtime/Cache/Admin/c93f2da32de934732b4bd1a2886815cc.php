...
<div id="content-header">
  <div id="breadcrumb"> 
    ...
    <a href="#" class="tip-bottom">申请提现</a> 
    <a href="#" class="current">申请提现</a> 
  </div>
  <h1>申请提现</h1>
</div>
...
<div class="container-fluid">
  ...
  <div class="row-fluid">
      <div class="widget-box">
        ...
        <form action ="/index.php/Admin/Deposit/statu" method="post" class="form-horizontal" enctype="multipart/form-data" >
        ...
        <div class="control-group">
          <label class="control-label">状态</label>
            <div class="controls"> 
              <?php if($list[0][statu] == 0): ?><label>
                    <input type="radio" name="statu" value="1"/>待打款
                  </label>
                  <label>
                    <input type="radio" name="statu" value="3"/>无效
                  </label>
              <?php else: ?>
                  <?php if($list[0][statu] == 1): ?><label>
                        <input type="radio" name="statu" value="2"/>已提现
