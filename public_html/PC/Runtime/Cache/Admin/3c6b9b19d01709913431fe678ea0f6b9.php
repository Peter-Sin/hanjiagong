  ...
  <div class="row-fluid"><?php echo ($list['title']); ?>
      <div class="widget-box">
        <div class="widget-content nopadding">
          <form action ="/index.php/Admin/Release/updatecontent" method="post" class="form-horizontal" enctype="multipart/form-data" >
            
            <div class="control-group">
              <label class="control-label"><h4>分类</h4></label>
              <input type="hidden" name="id" value="<?php echo ($list["id"]); ?>">
                <div class="controls">
                  <label>
                      <input type="radio" name="style" value="1"/>招聘要求
                  </label>
                  <label>
                      <input type="radio" name="style" value="2"/>职位描述
                  </label>
                </div>
            </div>

            <div class="control-group">
              <label class="control-label"><h4>添加信息</h4></label>
