...
<div id="content-header">
  <div id="breadcrumb"> <div id="breadcrumb"> <a href="#" class="tip-bottom" data-original-title="回到后台"><i class="icon-home"></i> 活动管理</a> <a href="#" class="tip-bottom">活动编辑</a> <a href="#" class="current">活动编辑</a> </div>
<!--   <h1>活动编辑</h1> -->
</div>
  ...
  <div class="row-fluid">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action ="/index.php/Admin/Company/update" method="post" class="form-horizontal" enctype="multipart/form-data" >
          ...
          <div class="control-group">
            ...
            <div class="controls controls-row">
              <input type="text" name="classify" value="<?php echo ($list[0][classify]); ?>">
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls controls-row">
              <input type="text" name="money" value="<?php echo ($list[0][wage]); ?>">
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls controls-row">
              <input type="text" name="dingjin" value="<?php echo ($list[0][earnest]); ?>">
            </div>
          </div>
          <div class="control-group">
          ...
          <div class="control-group">
            ...
            <div class="controls controls-row">
              <input type="text" name="qq" value="<?php echo ($list[0][qq]); ?>">
            </div>
          </div>
          ...
          <label class="control-label">待遇</label>
            <div class="controls">
              <?php if(is_array($list1)): foreach($list1 as $key=>$val): ?><label>
