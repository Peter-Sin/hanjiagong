        ...
        <table class="table">
            ...
            <tbody>
               <?php if(is_array($list)): foreach($list as $key=>$val): ?><tr class="gradeC">
                     ...
                     <td style="text-align:center" class="order"><?php echo ($val["order"]); ?></td>
                     <td style="text-align:center">
                        <?php if($val["statu"] == 0): ?><div class="statu" id="1" pid="1">待审核</div>
                        <?php else: ?>
                            <?php if($val["statu"] == 1): ?><div class="statu">审核通过</div>
                            <?php else: ?>
                              <div class="statu">无效</div><?php endif; endif; ?>
                     </td>
                     <td style="text-align:center"><?php echo ($val["time"]); ?></td>
                     <td class="center">
                        <div style="text-align:center;">  
                           <!-- <a href="/index.php/Admin/huodong/manage/id/<?php echo ($vale["id"]); ?>">图片管理</a>&nbsp;|
                           <a href="/index.php/Admin/huodong/xiangqin/id/<?php echo ($vale["id"]); ?>">活动详情</a>&nbsp;|
                           <a href="/index.php/Admin/huodong/bmer/id/<?php echo ($vale["id"]); ?>">已报名者</a>&nbsp;| -->
                            <?php if($val["statu"] == 0): ?><a href="/index.php/Admin/Grants/editstatu/id/<?php echo ($val["id"]); ?>">修改状态</a>
                            <?php else: ?>无<?php endif; ?>
                           <!-- <?php if($_SESSION['statu'] == 1): ?><a href="/index.php/Admin/Grants/del/id/<?php echo ($vale["id"]); ?>">删除</a>
                           <?php else: endif; ?> -->
                        </div>
                     </td>
