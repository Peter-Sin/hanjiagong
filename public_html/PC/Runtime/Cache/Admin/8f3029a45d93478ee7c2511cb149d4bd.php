      ...
      <div class="span12" >
        <div class="widget-box" >
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
              <h5>资源圈</h5><p style="margin:0px 0px 0px 500px;"><a href="/index.php/Admin/Release/add">添加资源</a><p>
          </div>
        <form action="/index.php/Admin/Grants/index" method="post">
        ...
        <table class="table">
            ...
            <tbody>
               <?php if(is_array($list)): foreach($list as $key=>$val): ?><tr class="gradeC">
                     ...
                     <td style="text-align:center"><?php echo ($val["begin_time"]); ?></td>
                     <td style="text-align:center"><?php echo ($val["end_time"]); ?></td>
                     ...
                     <td style="text-align:center"><?php echo ($val["contacts"]); ?></td>
                     <td style="text-align:center"><?php echo ($val["tel"]); ?></td>
                      <td style="text-align:center">
                        <?php if($val["statu"] == 1): ?><div class="statu" id="<?php echo ($val["id"]); ?>">√</div>
                        <?php else: ?>
                          <div class="statu" id="<?php echo ($val["id"]); ?>">×</div><?php endif; ?>
                      </td>
                     <td class="center">
                        <div style="text-align:center;">  
                          <a href="/index.php/Admin/Release/edit?id=<?php echo ($val["id"]); ?>">编辑信息</a>|

                          <a href="/index.php/Admin/Release/addcontent?id=<?php echo ($val["id"]); ?>">添加信息</a>
                          <?php if($_SESSION['statu'] == 1): ?>|<a href="/index.php/Admin/Release/del/id/<?php echo ($val["id"]); ?>">删除</a>
                          <?php else: endif; ?>
                        </div>
                     </td>
   ...
   $(function(){
         ...
         $(".statu").click(function(){
            ...
            var  gid=$(this).attr("id");
               $.get("/index.php/Admin/Release/statu/",{"id":gid},function(data){
                  if(data==1){
                     var val = abs.html();
                     if(val=="√"){                       
                        abs.html("×");
