...
<div id="content-header">
  <div id="breadcrumb"> <div id="breadcrumb"> <a href="#" class="tip-bottom" data-original-title="回到后台"><i class="icon-home"></i> 资源管理</a> <a href="#" class="tip-bottom">编辑</a> <a href="#" class="current">活动编辑</a> </div>
  <h1>编辑</h1>
</div>
  ...
  <div class="row-fluid">
      <div class="widget-box">
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <a href="/index.php/Admin/Release/index"><h4>返回上一级</h4></a>
        </div>
        <div class="widget-content nopadding">
          <form action ="/index.php/Admin/Release/update" method="post" class="form-horizontal" enctype="multipart/form-data" >
          
           <div class="control-group">
            <label class="control-label">标题</label>
            <div class="controls controls-row">
              <input type="hidden" name="id" value="<?php echo ($list[0][id]); ?>">
              <input type="text" name="title" value="<?php echo ($list[0][title]); ?>">
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls controls-row">
              <input type="text" name="money" value="<?php echo ($list[0][money]); ?>">
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls controls-row">
              <input type="text" name="town" value="<?php echo ($list[0][town]); ?>">
            </div>
          </div>
          <div class="control-group">
            <label class="control-label">详细地址</label>
            <div class="controls controls-row">
              <input type="text" name="address" value="<?php echo ($list[0][address]); ?>">
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls controls-row">
              <input type="datetime-local" name="begin" value="<?php echo ($list[0][begin_time]); ?>">
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls controls-row">
              <input type="datetime-local" name="end" value="<?php echo ($list[0][end_time]); ?>">
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls controls-row">
              <input type="datetime-local" name="close" value="<?php echo ($list[0][close_time]); ?>">
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls controls-row">
              <input type="text" name="total" value="<?php echo ($list[0][total]); ?>">
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls controls-row">
              <input type="text" name="contacts" value="<?php echo ($list[0][contacts]); ?>">
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls controls-row">
              <input type="text" name="tel" value="<?php echo ($list[0][tel]); ?>">
            </div>
          </div>
            ...
            <div class="form-actions">
              <button type="submit" class="btn btn-success" style="margin:0px 0px 0px 200px">确定</button>
