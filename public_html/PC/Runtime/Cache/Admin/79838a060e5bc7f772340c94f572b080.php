...
<div class="container-fluid">
  ...
  <div class="row-fluid">
      <div class="widget-box">
        ...
        <form action ="/index.php/Admin/Company/insert" method="post" class="form-horizontal" enctype="multipart/form-data" >
