  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> 
        ...
        <a href="#" class="tip-bottom">新闻管理</a> <a href="#" class="current">添加新闻</a> </div>
       <h1>添加新闻</h1>
    </div>
      ...
      <div class="row-fluid">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form action ="/index.php/Admin/Info/insert" method="post" class="form-horizontal" enctype="multipart/form-data" >
              ...
              <div class="form-actions">
                <button type="submit" class="btn btn-success" style="margin:0px 0px 0px 0px">确定</button>
