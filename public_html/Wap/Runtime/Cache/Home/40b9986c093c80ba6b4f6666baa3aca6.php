			...
			<ul class="clear">
				<!-- <li class="zxj_line">
					<div class="zxj_line0">
						<ul class="clear">
							<li>
								<span>助学金申请</span><span>已到账</span>
							</li>
							<li>
								<span>企业名称</span><span>富士康郑州园区</span>
							</li>
							<li>
								<span>工作日期</span><span>2017-10-12</span>
							</li>
							<li>
								<span>助学金额</span><span>500.00元</span>
							</li>
							<li><a href="#">查看详情></a></li>
						</ul>
					</div>
                        ...
                        html+=  "<li class='tx_line'>" +
                                    "<div class='zxj_line0'>" +
                                       "<ul class='clear'>"+
                                            ...
                                            "</li>"+
                                            "<li>"+
                                               "<a href='/index.php/Home/Grants/sqdetail?id="+data[i].id+"'>查看详情></a>"+                                             
                                            "</li>"+
                                       "</ul>"+
                                    "</div>"+
                                "</li>"
