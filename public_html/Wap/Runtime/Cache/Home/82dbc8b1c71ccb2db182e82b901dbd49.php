...
<div class="index_header">
  ...
  助学金申请结果<span class='yjtx_statu' style='display:none'><?php echo ($list['statu']); ?></span>
...
<div class="txresult1">
	...
	<div class="resultxx">
		<ul class="clear">
			...
			<li class="result_lines"><span>姓&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;名</span><span><?php echo ($list['name']); ?></span></li>
			<li class="result_lines"><span>企业名称</span><span><?php echo ($list['company']); ?></span></li>
			<!-- <li class="result_lines"><span>工期时间</span><span>2017-10-20到2018-2-20</span></li> -->
			<li class="result_lines"><span>工作日期</span><span><?php echo ($list['startime']); ?></span></li>	
...
<div class="share">
	<div class="share_title">
		<p>分享给我的朋友，赚取佣金</p>
		<p><span>我的推广码:</span><span><?php echo ($list['recode']); ?></span></p>
	</div>
	<div class="share_go">
